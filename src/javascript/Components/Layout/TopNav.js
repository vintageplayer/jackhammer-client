  ...
  render() {
    ...
    return (
      <header class="main-header">
        <a href="#" class="logo">
          <img src="/images/logo.png" alt="Jackhammer" height="50" width="190"/>
        </a>
        <nav class="navbar navbar-static-top" role="navigation">
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" onClick={this.props.toggleMethod}>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <ul class="menu">
                      ...
                      <li>
                        <a href="https://jch.olacabs.com/userguide" target="_blank">
                      ...
                      <li>
                        <Link to="/logout">
                          <i class="fa fa fa-sign-out pull-right"></i>
                          Logout
                        </Link>
                      </li>
                    </ul>
