...
import '../../../stylesheets/titatoggle-dist.css'
...
class Form extends Component {
  ...
  renderSaveOption(updateAllowed) {
    if (updateAllowed) {
      return (
    ...
    return (
      <MuiThemeProvider>
        <ValidatorForm onSubmit={this.handleSubmit}>
          ...
          <div class='row'>
            <div class='col-md-6'>
              {this.renderSaveOption(updateAllowed)}
            </div>
          </div>
        </ValidatorForm>
      </MuiThemeProvider>
...
const mapStateToProps = (state) => ({fetchedSeverityLevels: state.severityLevels.severityLevels, updateResponse: state.severityLevels.updateResponse, updateAllowed: state.severityLevels.updateAllowed});
